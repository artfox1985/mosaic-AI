<!-- STATUS: ENTSCHIEDEN | Frage: Hebt eine Implicit-Minimax-Beimischung im Backup (Q = (1-alpha)*Q_MC + alpha*v_minimax, alpha~0,2) die Ausdrucksfaehigkeit langer Linien in unserer Gumbel-Suche -- messbar an k1-Baurate und Staerke? | Beleg: Gebaut und abgenommen (par.1a); der Arena-Erfolg gegen die Heuristik (par.2b) ist als gegnerspezifisch widerlegt (par.2c). Self-Play-Arm am 2026-08-30 gefahren, kein Gewinn: Zustandsabdeckung 0,990, Zielentropie 0,2670 auf 0,2647. ENTSCHEID v22-b05-Erzeugung: alpha 0,0 (par.3b). -->
