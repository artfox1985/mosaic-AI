...
**UMGEZOGEN 2026-08-28 nach `PREREG_rust_data_layer.md` par.2** (dort gemeinsam
mit dem Vorschlag eines von Rust geschriebenen Rohformats registriert). Die
Vorbedingung aus par.5b dieser Datei gilt dort weiter: erst der Merkmalsanteil
neu gemessen, dann entschieden. Auch das Tor aus par.4 (Bit-Identitaet) wandert
unveraendert mit. Der folgende Text bleibt als Bestandsaufnahme stehen.
...
**Diese Regel gilt weiter, aber am neuen Ort:** Hebel (2) ist 2026-08-28 nach
`PREREG_rust_data_layer.md` par.2 umgezogen, und die Vorbedingung unten ist
dort zitiert und uebernommen.
