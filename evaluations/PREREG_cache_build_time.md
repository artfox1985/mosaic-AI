...
**NACHGETRAGEN 2026-08-28 (Fakt stand nur im Statuskopf, beim Kuerzen hierher
verschoben): das Tor IST inzwischen auf dem vollen Korpus gefahren, und es ist
GRUEN.** Serielle Referenz (`build_cache_serial`) gegen den parallelen Bau,
**alle 21 Felder ueber 4.186.112 Zustaende bit-identisch** (Rohbyte-Vergleich,
98 s, Artefakt `cache_parity_full_79.json`), gefahren auf der v22-Kodierung
(79 Kanaele, nativ). Der Absatz darueber beschreibt damit den Stand VOR diesem
Lauf; die dort empfohlene Referenzfahrt ist erledigt.
