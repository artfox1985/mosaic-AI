<!-- STATUS: ENTSCHIEDEN | Frage: Verpasst die fixe Gumbel-Wurzelmenge gute Zuege (E), hilft groessere Wurzelbreite (F), wie steht die sigma/Prior-Balance in der WDL-Aera (G)? | Beleg: E Miss-Rate 1,21 % => Regel 1; F nicht eingetaktet; G Aera-Effekt bestaetigt (1,232 -> 2,287), Schwelle 3 nicht erreicht. par.G3: b01 misst 2,814 @400 gegen 2,135 @100, die kausale Rolle fuer die Spalten-Delle ist aber GEPRUEFT UND WIDERLEGT (gumbel_c_scale_arm par.5). Keine Wiedereroeffnung, Pflicht-Diagnostik je Champion bleibt. -->
