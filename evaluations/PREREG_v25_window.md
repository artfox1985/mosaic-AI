<!-- STATUS: ENTSCHIEDEN | Frage: Wie wird das v25-Trainingsfenster zugeschnitten (G = v24), und wie wird der Spaltenbau gegen schleichendes Verlernen gesichert? | Beleg: Fenster GEBAUT 2026-09-08 (par.20), v25-b01 trainiert, promoviert (Elo 1355) und am 2026-09-09 von v26-b01 abgeloest. Generator war v24-b07 (par.14f). Tragende Regeln fuer die Folgegenerationen: par.17 (stationaerer Zustand), par.18 (Einfrieren bis v27-b01: nur das Material aendert sich), par.19a (--games zaehlt Ausfluege mit). Kopf berichtigt 2026-09-09, er sagte noch 'nichts gebaut'. -->
