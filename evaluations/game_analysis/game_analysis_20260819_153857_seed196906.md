...
Erzeugt von `tools/analyze_game_log.py` (Commit `98a513a`), Laufzeit 2s.
...
- KI: nicht bewertete Züge -- 40× --no-oracle, 8× Runde 5 -- exakter Alpha-Beta-Solver (round5.rs), nicht netz-oracle-bewertet
