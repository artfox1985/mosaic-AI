<!-- STATUS: ENTSCHIEDEN | Frage: Wird die Engine von prozessglobalem Zustand geloest (AgentSpec je Seite), sodass ein eingefrorener Champion sauber messbar ist? | Beleg: JA (par.8f: Welle 3 gruen, 8/8 byte-identische Partien; par.9 Heuristik; par.10 Referee-Pfad zu). Offen: Ausbau der ~31 Knoepfe (par.4); Artefakt gegen Artefakt (par.10a); Quellkopie round5_anchor.rs erst weg, wenn die Arenen den Anker aus dem Artefakt ziehen (par.10a). par.12: Remis-Regelfehler behoben (Anker-Kante 127:23). par.13: der Anker IST das Artefakt (hv1_anchor, Drift und Konservierung gruen), Leiter verbunden. -->
