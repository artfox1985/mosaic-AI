<!-- STATUS: ENTSCHIEDEN | Frage: Die Spezialfliesen sind der groesste unabgeholte Posten auf dem Brett; laesst sich das heben, und an welchem Hebel? | Beleg: K5 gebaut und einfaktoriell gemessen (par.9b-9d). Er hebt die vollen Spalten am staerksten von allem Gemessenen (Instrument 0,5725 -> 0,6900; Champion-Bezug 0,4975) und ist siegneutral (243:257 ueber 500 Partien, KI [0,442; 0,530]). ABER der Wirkungsweg ist NICHT der gebaute: das Spezialfeld-Kriterium wird leicht schlechter, die Punkte kommen aus vertikalen Reihen und Eckplatten. Seit 2026-09-07 in der Champion-Spec (v24-b07). Das erste Vorzeichen 71:89 war Rauschen, von der Nachmessung widerlegt (par.9d). -->
