...
| 32a | `moon_stack_order` par.10 Weg C | **Terminierung statt Sim-Zahl**: die Nachsuche der Reihenfolge rechnet bis zum RUNDENENDE statt auf ein festes Budget (Nutzer 2026-09-14: "da brauchst schon ein wenig weitsicht. zumindest rundensicht."). Ausloeser ist der Nullbefund von Nr. 29a: die Nachsuche greift oft (24,34 echte Wahlen je Partie, par.9b) und aendert am Ausgang nichts -- also nicht Seltenheit, sondern Horizont oder Entscheidungsform. Bau plus PFLICHT-Kostentor (der Preis ist stellungsabhaengig: nahe am Rundenende billig, frueh teuer), dann A/B am Champion | Maschine frei (ein Rust-Bau ist Volllast), Ergebnis Nr. 29a | Bau rund 3 h (ANNAHME), Kostentor rund 24 min je Lauf, A/B rund 1,5 h (gemessen) | **ja** -- gerissenes Kostentor beendet den Arm |
