...
27-30 und 29a sind durch; 31/32 gegenstandslos; 22/37 auf v30 vertagt. Offen: Nr. 20 Punkte 3-5,
...
| 20 | `v29_window` par.6d | **Netz-Gesundheit**. **Punkte 1 und 2 DURCH 2026-09-14**: tote Einheiten bei allen vier Modellen 2,60 Prozent (GRUEN, kein Zuwachs durch die neuen Eingaenge), und von den 39 neuen Spalten leben 17 -- die 22 toten sind genau die vorhergesagten (18x P.12 ohne Korpusfeld, 4 Phasen, die im Korpus nicht vorkommen). Punkte 3 bis 5 offen | Nr. 12/16/18 | Bau rund 1 h, Laeufe Minuten je Modell (ANNAHME) | nein |
...
| 32a | `moon_stack_order` par.10 Weg C | **Terminierung statt Sim-Zahl**: die Nachsuche der Reihenfolge rechnet bis zum RUNDENENDE statt auf ein festes Budget (Nutzer 2026-09-14: "da brauchst schon ein wenig weitsicht. zumindest rundensicht."). Ausloeser ist der Nullbefund von Nr. 29a: die Nachsuche greift oft (12,20 Entscheidungen je Partie, par.9i) und waehlt dabei in 62 Prozent der Faelle ANDERS als kanonisch -- und aendert am Ausgang trotzdem nichts -- also nicht Seltenheit, sondern Horizont oder Entscheidungsform. Bau plus PFLICHT-Kostentor (der Preis ist stellungsabhaengig: nahe am Rundenende billig, frueh teuer), dann A/B am Champion | Maschine frei (ein Rust-Bau ist Volllast), Ergebnis Nr. 29a | Bau rund 3 h (ANNAHME), Kostentor rund 24 min je Lauf, A/B rund 1,5 h (gemessen) | **ja** -- gerissenes Kostentor beendet den Arm |
