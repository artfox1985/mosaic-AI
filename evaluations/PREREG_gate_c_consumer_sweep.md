<!-- STATUS: ENTSCHIEDEN | Frage: Tor C -- traegt der Ownership-Verbraucher (Blatt-Pol plus Tiling-Pol) in der Arena Plattenpunkte ein, OHNE Siege zu kosten -- und welcher Kopf traegt ihn? | Beleg: NEGATIV (2026-08-16, 970 Partien, par.15): kein Arm hebt k1/k2/k5, Siege fallen monoton mit der Dosis; der staerkere Kopf w1-final macht den Verbraucher inert (91:91), Kopfguete ist nicht der Engpass. Beide Regler bleiben auf 0. Offen: Stufe 5 Durchsatz bleibt vorregistriert (par.14), k6-Isolierung braucht eigene Prereg (par.15 P.5). Nachtrag par.16.1: Prior-Ratio b05 Median 1,23. -->
