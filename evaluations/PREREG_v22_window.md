<!-- STATUS: ENTSCHIEDEN | Frage: Wie wird das v22-Trainingsfenster zugeschnitten? | Beleg: ZUSCHNITT ENTSCHIEDEN 2026-08-25 (par.2): 24.000 Partien hv2, eine Klasse, kein Altbestand, ~4,18 Mio Zustaende; Alt-Zuschnitt hinfaellig (par.1). TRAEGERFRAGE par.4 entschieden: Flagge IGNORIEREN (Arm B besser, keine Kennzahl einzeln signifikant, par.4a/4b); Stand der Kanal-Frage ist par.4e (par.4c/4d ueberholt), naechste Konfiguration Arm B plus OWNERSHIP_WEIGHT>0. par.4f: das DRAFTING traegt es (0,756), das Routing allein nichts (0,000). par.6 Val-Pool UEBERHOLT, v22 als Kaltstart. -->
