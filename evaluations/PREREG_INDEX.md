...
| `PREREG_ownership_selector.md` | Traegt der Ownership-Kopf, wenn er als SELEKTOR ueber eine Vorzugsroute im Tiling wirkt statt als Gewicht in der Blatt- und Nachsortier-Bewertung? | **ENTWURF 2026-08-16**, nichts gebaut. Anlass: Tor C negativ (Regler) UND Destillation ohne Zielkriterien-Wirkung (par.10.2 dort) -- beide Wege des Verbrauchers gescheitert, Diagnose heute am Code gefuehrt (par.1). Nutzer-Auftrag: "der ownership head muss rein". |
