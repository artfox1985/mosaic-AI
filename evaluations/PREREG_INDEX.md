...
**Stand (automatisch generiert): 56 Dateien = 15 OFFEN + 40 ENTSCHIEDEN + 1 UEBERHOLT.**
...
| `PREREG_gate_c_consumer_sweep.md` | Tor C -- traegt der Ownership-Verbraucher (Blatt-Pol MOSAIC_OWNERSHIP_W + Tiling-Pol MOSAIC_OWNERSHIP_TILING_W, gemeinsam gefahren) in der Arena Plattenpunkte ein, OHNE Siege zu kosten -- und welcher Kopf (F1 eingefroren vs w1-final) traegt ihn? | **OFFEN, vorregistriert 2026-08-16.** Nichts gefahren zum Zeitpunkt der Registrierung. Nullarm ist DERSELBE Checkpoint mit Regler 0, nicht der Champion. Drei Dosisstufen als Paare (0,1/0,3 -- 0,3/1,0 -- 1,0/3,0), hergeleitet aus den Punktskalen beider Formeln (par.3). Vorab-Erfolgsregel: Plattenpunkt-Gewinn OHNE signifikanten Sieg-Verlust; Praezedenz k6-Kuppeldraft und Stoerungs-v1. |
