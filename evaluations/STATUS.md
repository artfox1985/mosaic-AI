...
**Naechster Schritt danach:** der **v22-b01-Kaltstart** (A0, Schritt 3).
...
### Erledigt und ausgelagert (2026-08-28)
...
Herleitung samt Ergebnistabelle in `../archive/history.md` (Kapitel
2026-08-25 bis 2026-08-28, Abschnitt "B-Strang: Ergebnistabelle"). Die zwei
weitergeltenden Regeln leben dauerhaft: Anker-Messung ueber
`tools/anchor_arena.py` in `../docs/working_rules.md`, der
Huellen-Geometrie-Hinweis in `PREREG_heuristic_v2_long_rows.md` par.3b.1.
...
## STELLUNGSVIELFALT DES LEHRER-KORPUS: ERLEDIGT 2026-08-25

Der Lehrer-Korpus hat MEHR verschiedene Stellungen als v1 (Faktor 1,026,
weniger Wiederholungen) -- Herleitung und Grenzen der Aussage in
`../archive/history.md` (Kapitel 2026-08-25 bis 2026-08-28). Sonde:
`tools/probes/corpus_state_diversity_probe.py`.
