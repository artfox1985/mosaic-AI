...
1. CPU-Bahn: ~~τ-Annealing-Batch~~ **FERTIG 2026-08-07 15:00 (2.000
   ...
   **Denial-Tie-Break-Messung (E3, PREREG_denial_tiebreak.md --
   ...
   Default-Paritaets-Hash bitgleich, ε=0,03 nachweislich wirksam)**.
   DANACH (NEUE REIHENFOLGE, Nutzer-Einwand 2026-08-07 abends):
   **Modell-Verdikte VOR Korpus-Generierung** -- der v20-Schwarm wurde
   nach 2.090 Partien GESTOPPT und nach data_quarantaene/ geparkt
   (Generator-Wahl haengt am Endgame-Gating: gewinnt pi_endgame_s2,
   generiert der NEUE Champion; bleibt der alte, kehren die 209
   Dateien zurueck und der Schwarm laeuft die restlichen 5.910
   weiter). Reihenfolge: Endgame-Verdikt+Gating -> τ-Arm-B+Gating ->
   Schwarm+Sockel vom finalen v20-Aera-Champion.
