...
| **λ (Value-Target-Mix)** | **AKTIVIERT (Nutzer-Anstoss 2026-08-08; Zahl vom Nutzer korrigiert)**: Mischanteil zaehlt ZUSTAENDE, Deckel ~65% (Tiling/Start/Ein-Aktions-Zuege tragen nie root_q). v21-Fenster: alles ab v18 loggt -> Zustands-Mix ~65-66% = FAST EXAKT das v18only-Regime (66%), in dem λ=0,7 arena-signifikant GEWANN -> λ=0,7-Arm in die GPU-Queue hinter t3ann_s2 |
