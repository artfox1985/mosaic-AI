...
| `v24-b04` (Sicht-Arm, INPUT_SIZE 744: Plattentyp, Strafleisten-Farben, Phantom-Anteile) | 17:21-20:51 mit Unterbrechung (Harness-Stopp 19:39 in Epoche 9, per `--resume` ab Epoche 9 fortgesetzt, Chronik), 13.305 s Wanduhr ueber beide Segmente (Datenaufbau 98 s im zweiten), `_brierbest` Epoche 4 (val_brier 0,1922), `_best` Epoche 1; Brier-Verlauf 0,1929 / 0,1924 / 0,1922 / 0,1922 / 0,1924 / 0,1928 ... 0,1929 -- Minimum frueh wie bei b01/b02, danach Erosion | -- | -- | -- | Abnahme in der Nachtkette nach Wheel 744 (parallel zum b03-Training) |
