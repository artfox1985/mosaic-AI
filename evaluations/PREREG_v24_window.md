...
| `v24-b06` (b02-Rezept lambda 0,7 auf Sicht 744; Nutzer 2026-09-06 11:55 "starte A und B": Rueckfall-Kandidat fuer einen 744er-Champion) | 2026-09-06 11:47-13:07, 4.845 s (`--fast-loader`, Datenaufbau 82 s), 4,87 Mio Samples, `_brierbest` Epoche 4 (val_brier 0.1926); Brier-Verlauf 0,1932 / 0,1928 / 0,1926 / 0,1926 / 0,1926 / 0,1930 / 0,1928 / 0,1930 / 0,1930 / 0,1928 / 0,1931 / 0,1930 -- Minimum frueh, danach flach wie bei allen Armen; Manifest `manifest_train_v24-b06_20260906_114705.json` (traegt `fast_loader` und `laufzeit.lader`) | -- | -- | -- | Abnahme laeuft seit 13:22 (`night_v24_b06_chain.sh`, 744er-Basis-Wheel mit K3-F Default aus). **Tor 2a OHNE Knopf (13:50, `tor2a_v24b06nk.json`): 0,475 volle Spalten (KI +-0,067), Punkte 46,2, Zeilen 0,195, Strafleiste 5,9** gegen b01 ohne Knopf 0,510 (KI schliesst ein) -- gegen das 714er-b02 (0,430) spaltenreicher. **Tor 1 OHNE Knopf (15:01, Seed 20261016, `paired_gating_result_v24-b06_vs_v23-b01_noknob_s16.json`): 216:184 nach 200 Paaren, KEIN SPRT-Entscheid (LLR +0,05), McNemar p 0,14, Diff +0,16 [-0,04, +0,36], Punkte 45,1 gegen 43,7; 4.233 s** -- wie b01/b03/b04; der Knopf-lose Beleg des 714er-b02 (209:161) tritt in der 744er-Fassung nicht auf. Elo-Kante `v24-b06` gegen `v23-b01_brierbest`. **Tor 2a MIT Knopf (15:25, `tor2a_v24b06.json`): 0,4975 volle Spalten (KI +-0,066), Punkte 48,3, Zeilen 0,200, Strafleiste 5,9** gegen Bezug 0,555 (KI schliesst ein); Knopf +0,0225 (b02-714: +0,095). **Tor 1 MIT Knopf (16:01, beide Seiten Champion-Spec, Seed 20261012, `..._s12.json`): 117:83 nach 100 Paaren, SPRT-ENTSCHEID fuer v24-b06 (LLR +3,05), McNemar p 0,019, Diff +0,34 [+0,08, +0,60], Punkte 46,6 gegen 42,4; 2.087 s** -- das ist zugleich die Champion-Kante in Spielkonfiguration (b06 mit K3-P gegen v23-b01_k3p10); Fruehstopp < 150. **Replikation Seed 20261013 (17:04, `..._s13.json`): 202:158 nach 180 Paaren, erneut SPRT-ENTSCHEID fuer v24-b06, McNemar p 0,017, Diff +0,24 [+0,05, +0,43], Punkte 48,2 gegen 45,4; 3.833 s. Gepoolt 319:241 aus 280 Paaren, zwei unabhaengige Seeds -- Champion-Strenge MIT Knopf erfuellt (b02 192:128, b03 214:146).** Elo-Knoten `v24-b06_k3p10` gegen `v23-b01_k3p10`. **Tor 2b (17:30, `paired_arena_env_v24b06_vs_b01_{first,second}_s14.json`, beide Seiten Champion-Spec, Seed 20261014, je 80): Siege 48:32 (b06 auf Brett 0) und 43:37 (b06 auf Brett 1), zusammen 91:69; volle Spalten b06 0,575 / 0,725 gegen b01 0,650 / 0,625 (SE 0,08-0,09; eine Richtung darunter, eine darueber, gepoolt 0,65 gegen 0,64), Punkte 46,2 / 48,0 gegen 41,6 / 46,5, Strafleiste 10,4 / 10,7 gegen 12,7 / 11,0, Kuppel-Bonus 3,6 / 4,2 gegen 4,0 / 4,5, lange Reihen begonnen/vollendet 4,28/2,67 und 4,24/2,94 gegen 4,19/2,64 und 4,30/2,64 -> Spalten GLEICHAUF, NICHT GEFALLEN.** **Abnahme komplett (17:30).** Bilanz b06: Tor 2a ohne Knopf 0,475 und mit Knopf 0,4975 (KI schliesst Bezug ein); Tor 1 ohne Knopf 216:184 ohne Beleg, MIT Knopf 117:83 + 202:158 SPRT (Champion-Kante, zwei Seeds); Tor 2b gleichauf, Siege 91:69. Profil wie b03 (Tor 1 nur mit Knopf, Spalten gleichauf), aber auf Sicht 744 |
