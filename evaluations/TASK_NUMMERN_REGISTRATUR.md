...
| 68 | Gumbel-Suche Tiefe >=1 mctx-treu (`gumbel_select_child`) | entschieden -- umgesetzt, Teil des Speedbundles; eine separate Nachvalidierung "Phase 2" blieb als offener Merkposten in der Historie stehen | `archive/history.md:1309`, `archive/history.md:1425` |
