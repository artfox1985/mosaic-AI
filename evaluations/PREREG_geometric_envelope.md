<!-- STATUS: ENTSCHIEDEN | Frage: Entlastet die geometrische Einhuellende den Value-Kopf und spielt das Netz dadurch stabiler? | Beleg: JA, zweimal. K3-P (Modus 1, C 1,0) ist Champion-Knopf seit 2026-09-04 (par.11). Die HUELLENFORM 2 (zweite Zelle in Rasterzeile 6) schlaegt den Champion gepoolt ueber drei Seeds 391:329 = 0,543, Vorzeichentest p 0,023, KI [0,507; 0,579] (par.8.15e) und steht seit 2026-09-07 in der Spec (v24-b07). Vier weitere Knopf-Arme am Champion NEGATIV: K3-P2 71:89, K3-F 1,0 74:86, K3-F 0,5 77:83, beide 69:91 (par.8.11a, 8.14). Lesart der SPRT-Deckel-Faelle vorab in par.8.15d. -->
