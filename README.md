...
by filename), and `render_diagrams.py` plus the `.svg` diagrams it
generates. `game_analysis_*.md` reports are generated by the game-analysis
tool (`tools/analyze_game_log.py`).
