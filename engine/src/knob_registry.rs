...
pub const KNOBS: &[KnobEntry] = &[
    ...
    KnobEntry { name: "MOSAIC_WERTUNG_SCALE_PROFILE", default: "aus (=0/leer; 1 oder an = Rundenprofil)", status: KnobStatus::Diagnose, purpose: "Baustein 3: rundenabhaengiger Nenner SCALE_r=50*profil_r fuer den Wertungsplatten-/Spezialfeld-Term (Pfad A); Strafleisten-/Tiling-Term bleiben auf dem flachen Nenner (net_mcts.rs, wertung_scale_profile_active)", prereg: "PREREG_shaping_scale_per_round.md par.4/par.6a" },
    ...
    KnobEntry { name: "MOSAIC_ASYM_VORZUG", default: "aus", status: KnobStatus::Diagnose, purpose: "Baustein 1 (Arm S): je Self-Play-Partie bekommt GENAU EINE Seite den Bauer-Vorzug (vorzug:true), Seitenwahl deterministisch aus dem Partie-Seed 50/50; dome_vorzug faehrt in derselben Kette mit (self_play.rs, asym_vorzug_active/asym_vorzug_seite)", prereg: "PREREG_asymmetric_curriculum.md par.3" },
