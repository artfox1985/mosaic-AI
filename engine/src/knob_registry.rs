...
pub const KNOBS: &[KnobEntry] = &[
    ...
    KnobEntry { name: "MOSAIC_ACTION_TEMP", default: "0.0 (= aus, rohe Besuchszahlen)", status: KnobStatus::Diagnose, purpose: "Arme S2/S5 der v25-Sockelstruktur: aktionsabhaengige Temperatur fuer die ZUGWAHL im Netz-Self-Play, Staffel wie im Heuristik-Pfad (n>50 -> 0,7; n>15 -> 0,4; sonst 0,15). Gewichte werden visits^(1/T) statt visits; das Policy-ZIEL (completed-Q) bleibt unberuehrt. Bei 0 exakt die rohen Besuchszahlen, bitidentisch (net_mcts::action_temp_enabled, self_play::action_temp_weights)", prereg: "PREREG_v25_window.md par.14" },
