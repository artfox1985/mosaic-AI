...
pub const KNOBS: &[KnobEntry] = &[
    ...
    KnobEntry { name: "MOSAIC_ENVELOPE_PROJECTED", default: "0 (aus)", status: KnobStatus::Aktiv, purpose: "K3-P par.8.7 (Nutzer 2026-09-03): der Such-Term (e) rechnet H auf dem PROJIZIERTEN Brett -- Raster plus Musterreihen anteilig auf ihre annehmenden Zielzellen der Rasterzeile r (k/(r+1) je Reihe, gleich verteilt ueber die n annehmenden Zellen; envelope.rs projected_occupancy). Grund: Zellen fuellen sich nur im Tiling, im Draft-Suchbaum war H konstant und der Term wirkungslos (par.9). Prozessweit (OnceLock), gefahrlos fuer den Spiegelmatch, weil der Term je Seite ueber envelope_search_c gegated ist", prereg: "PREREG_geometric_envelope.md par.8.7" },
    // ── Runde 5 (round5.rs) ─────────────────────────────────────────────────
