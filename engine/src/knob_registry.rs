...
pub const KNOBS: &[KnobEntry] = &[
    ...
    KnobEntry { name: "MOSAIC_CARRIER_MANIFEST", default: "policy_carrier_manifest_v20.json", status: KnobStatus::Aktiv, purpose: "Dateiname des Policy-Traeger-Manifests im Korpus-Ordner (corpus_dataset.py, MosaicDataset.__init__)", prereg: "PREREG_v21_window.md" },
