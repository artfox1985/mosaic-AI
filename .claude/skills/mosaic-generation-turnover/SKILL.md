...
- Wurde die Engine seit dem letzten Anker-Check geaendert oder das Wheel
  ...
  `models/frozen_heuristics/hv4_anchor`, seit 2026-09-12). ROT ist Nutzer-Entscheid, kein
  Reparaturauftrag.
...
- Kette fuer G+1 nach dem Muster `night_v30_chain.sh` schreiben (Vorgaenger-Ketten sind nach ihrem Zyklus geloescht, die Historie behaelt sie) (Manifest,
