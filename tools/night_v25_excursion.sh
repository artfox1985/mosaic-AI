...
#
# AUFFUELL-LAUF (par.19a): der erste Lauf mit --games 2000 lieferte nur 2.002 Identitaeten,
# nicht 4.000 -- der Ausflug hat eine eigene game_id und zaehlt gegen --games
# (self_play.py:689-692 zaehlt je _group_by_game-Eintrag, self_play.rs:4753 nur je
# Hauptpartie; der Python-Zaehler entscheidet). Dieser zweite Lauf mit eigenem Seed fuellt
# die Klasse auf rund 4.000 Identitaeten auf.
#
...
python -X utf8 -u self_play.py --mode network \
  ...
  --games 2000 --sims 100 --value-only --version v24-b07-value-excursion2 \
  --threads 11 --chunk 10 --per-file 10 --seed 20260910 \
