...
[ -f "$REF_TRAIN_MANIFEST" ] || echo "WARNUNG: Referenz-Manifest $REF_TRAIN_MANIFEST fehlt -- Diff von Hand"
...
PYEOF
RC=$?
[ $RC -eq 0 ] || { echo "STOPP: Traeger-Manifest traegt nicht 580/400/135/45"; exit 10; }
