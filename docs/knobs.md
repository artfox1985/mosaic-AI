...
Stand: 99 Knoepfe (62 aktiv, 29 diagnose, 7 tot, 1 geplant).
...
**65 verdrahtete Knoepfe haengen an einer BEANTWORTETEN Prereg** (entschieden oder ueberholt).
...
**Beantwortet, Default AN (24)** -- in Benutzung, hier ist "entschieden" das Ergebnis, nicht das Ende:
