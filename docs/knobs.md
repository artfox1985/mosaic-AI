...
**70 verdrahtete Knoepfe haengen an einer BEANTWORTETEN Prereg** (entschieden oder ueberholt).
...
**Beantwortet UND Default aus (45)** -- hier lohnt die Nachfrage,
...
- `MOSAIC_ENVELOPE_SEARCH_C` (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.2; PREREG_v24_window.md par.8)
- `MOSAIC_ENVELOPE_TILING_W` (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.3)
- `MOSAIC_ENVELOPE_TILING_VALUE_W` (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.6)
- `MOSAIC_ENVELOPE_PROJECTED` (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.7)
- `MOSAIC_ENVELOPE_FLUSH_W` (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.14)
- `MOSAIC_SPECIAL_ROW6_W` (ENTSCHIEDEN, PREREG_special_tile_yield.md par.9)
...
- `MOSAIC_ENVELOPE_PROFILE` = 1,0.92,0.67,0.33,0 (b01-Kurve) (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.5)
- `MOSAIC_ENVELOPE_REACH_W` = 0.25 (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.9)
- `MOSAIC_ENVELOPE_SLOT_W` = 0.5 (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.9b, par.8.11)
- `MOSAIC_ENVELOPE_HULL_FORM` = 1 (Dreieck) (ENTSCHIEDEN, PREREG_geometric_envelope.md par.8.15)
...
| `MOSAIC_PLATTENBAU` | aus (0..8 oder auto) | diagnose | - | generischer Plattenbauer fuer alle 8 Wertungskriterien (plate_builder.rs:83); 8 = Huellen-Bauer (PREREG_geometric_envelope.md par.8.8, 2026-09-03): Draft-, Kuppel- und Tiling-Vorzug auf die Zellen der bestpassenden Dreiecks-Huelle, Zielkarte = Zellenkosten r+1, Orientierung per Kostenvergleich | STATUS.md Architektur-Fahrplan P.5 |
