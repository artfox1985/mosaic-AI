...
| `v23-b07` | **Reanalyze-Arm** (`PREREG_reanalyze_label_depth.md` par.A4, eingetaktet 2026-09-02): dieselben Partien wie b01, Draft-Policy-Ziele mit dem Generator selbst bei 400 Sims nachgerechnet; b05 war der Lehrer-Relabel, b07 ist Reanalyze im engeren Sinn |
