...
**Stand: 230 Dateien** = 107 WIRED + 59 DOCUMENTED + 52 CHRONICLE + 12 UNNAMED.

## WIRED (107)

| Datei | Zweck | Genannt von | Letzter Commit |
| --- | --- | --- | --- |
| `tools/analyze_game_log.py` | tools/analyze_game_log.py -- wiederverwendbares Werkzeug zur Analyse von | Aufruf 13, Kommentar 10, Regeln 2, docs 4, evaluations 55 | 2026-09-10 |
| `tools/anchor_arena.py` | Arena gegen den EINGEFRORENEN Anker (B2 der Kapselungs-Kette). | Kommentar 2, Regeln 1, docs 4, evaluations 6 | 2026-09-12 |
| `tools/arena.py` | Mosaic-AI — Arena (Rust-Engine) | Aufruf 16, Kommentar 10, Regeln 2, docs 7, evaluations 41 | 2026-08-05 |
| `tools/argmax_profile.sh` | argmax-Instrument (Tor 2a, docs/generation_loop.md): 200 Partien @400, Seed 20260931, deterministisch, | Regeln 1, evaluations 7 | 2026-09-04 |
| `tools/backup_common.ps1` | (kein Kopfkommentar) | Aufruf 3, Kommentar 1, docs 1 | 2026-08-31 |
| `tools/build_cache_incremental.py` | Cache JE DATEI, auch WAEHREND der Erzeugung (PREREG_cache_build_time.md par.6, | Aufruf 5, Kommentar 1, docs 6, evaluations 11 | 2026-08-31 |
| `tools/build_cache_parallel.py` | Parallel gebauter Trainings-Cache (PREREG_cache_build_time.md Hebel 1). | Aufruf 3, Kommentar 2, docs 3, evaluations 1 | 2026-09-11 |
...
| `tools/check_conventions.py` | tools/check_conventions.py -- Konventions-Linter (Baustein A5). | Aufruf 6, Kommentar 2, Regeln 2, docs 4, evaluations 12 | 2026-09-12 |
| `tools/claude_play.py` | Spiel-Interface Claude gegen Netz (PREREG_claude_play_interface.md, Nutzer-Auftrag 2026-09-06). | Aufruf 3, docs 2, evaluations 10 | 2026-09-13 |
...
| `tools/corpus_sanity_check.py` | Sanity-Check eines Self-Play-Korpus auf den sechs Standard-Kennzahlen | Aufruf 9, docs 4, evaluations 25 | 2026-09-05 |
...
| `tools/elo_tracker.py` | Mosaic-AI -- Elo-Tracking-Infrastruktur (Task #62) | Aufruf 4, Kommentar 1, Regeln 3, docs 6, evaluations 9 | 2026-09-13 |
...
| `tools/frozen_referee_match.py` | Wave-3-Referee (PREREG_agent_encapsulation.md par.8): Partie-Serie Seite A | Aufruf 6, Kommentar 2, Regeln 1, docs 4, evaluations 13 | 2026-09-12 |
...
| `tools/generate_prereg_index.py` | tools/generate_prereg_index.py -- erzeugt den Tabellenteil von | Aufruf 2, Regeln 4, docs 4, evaluations 17 | 2026-08-15 |
...
| `tools/night_v28_chain.sh` | v27-Kette: Traeger-Kennzahl, Traeger-Manifest, Fenster, Bloecke, Monolith, Training v28-b01. | Regeln 1, docs 1, evaluations 3 | 2026-09-10 |
...
| `tools/oracle_metrics.py` | tools/oracle_metrics.py -- Task #89 Teil B, Schritte 2-3: Offline-Metriken der | Aufruf 7, Kommentar 1, docs 3, evaluations 11 | 2026-09-12 |
...
| `tools/paired_gating.py` | Gepaartes Netz-vs-Netz-Gating als STANDARD-Werkzeug fuer Kandidaten- | Aufruf 13, Kommentar 3, docs 6, evaluations 29 | 2026-09-12 |
...
| `tools/plate_points_from_arena.py` | Wertungsplatten-Punkte und Strafleiste aus gepaarten Arena-Ergebnissen ziehen. | Aufruf 2, Kommentar 1, Regeln 2, docs 4, evaluations 27 | 2026-09-10 |
...
| `tools/probes/anchor_referee_parity_probe.py` | DAS TOR vor der Anker-Umstellung: spielt der Referee-Pfad dieselben Partien | Aufruf 1, evaluations 3 | 2026-08-28 |
| `tools/probes/arena_column_probe.py` | Volle Spalten in der ARENA -- aus den Partie-Logs rekonstruiert. | Aufruf 3, docs 3, evaluations 20 | 2026-09-10 |
...
| `tools/probes/feature_parity_rust_python.py` | Bit-Identitaets-Tor fuer den Merkmalsbauer: Rust gegen Python. | Aufruf 1, Kommentar 2, docs 3, evaluations 3 | 2026-09-11 |
...
| `tools/probes/start_dome_tile_probe.py` | Stufe 0, Teil 2 der Startkuppel-Frage: taugt die Handregel bei PLATTE und | Aufruf 1, docs 1, evaluations 2 | 2026-09-12 |
...
| `tools/spec_add_field.py` | Ein Pflichtfeld in lebende Spec-Dateien nachziehen (models/*.spec.json). | Aufruf 3, Kommentar 1, docs 1, evaluations 3 | 2026-09-07 |
...
| `tools/verify_frozen_heuristic.py` | Prueft ein eingefrorenes Heuristik-Artefakt gegen seine Golden Probe. | Aufruf 3, Kommentar 4, Regeln 1, docs 2, evaluations 9 | 2026-09-13 |
| `tools/window_train_split.py` | tools/window_train_split.py -- den Train/Val-Split von train.py VORAB | Aufruf 1, docs 2, evaluations 5 | 2026-09-02 |
...
| `tools/tests/test_action_id_mirror.py` | Waechter gegen stille Aktions-ID-Kollisionen: Python-Spiegel gegen Rust. | Kommentar 1, docs 1 | 2026-09-12 |
...
| `tools/night_v29_generate.sh` | v29-ERZEUGUNG: die drei Klassen nacheinander, Generator v28-b02. | evaluations 2 | 2026-09-13 |
...
| `tools/probes/value_head_reliability_probe.py` | rho(r) des Value-Kopfs je Runde auf frozen_v3 plus Rauschboden (PREREG_geometric_envelope.md par.8.5, par.12a B1/B2, par.12b Punkte 1 und 2). | evaluations 3 | 2026-09-06 |
...
| `tools/tests/test_claude_play_board_hints.py` | Die Brett-Hilfen von `tools/claude_play.py` an nachgebauten Stellungen. | evaluations 1 | 2026-09-13 |
